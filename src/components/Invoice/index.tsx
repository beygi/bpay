...
class Invoice extends React.Component<IProps, IState> {
    ...
    public render() {
        ...
        invoice.priceComponent = <Ex floatsNum={3} value={invoice.payerAmount} seperateThousand />;
        invoice.checkoutComponent = <Ex floatsNum={3} value={invoice.merchantAmount} seperateThousand />;
        return (
