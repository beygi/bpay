...
import {
    faAddressCard, faArchive, faArrowLeft, faBalanceScale, faBox, faChartLine, faCheck, faCheckDouble, faCode, faCopy,
    faDollarSign, faDonate, faEdit, faExchangeAlt,
    faExternalLinkAlt, faHandHolding, faHandHoldingUsd, faHandshake, faHistory, faHourglassHalf, faKey, faLink, faList,
    faLock, faMoneyCheckAlt, faMoon, faPlus, faQrcode, faSearch, faShareAlt, faSnowflake, faSquareFull, faThList,
