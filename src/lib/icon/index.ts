...
import {
    faAddressCard, faAngleDown, faArchive, faBalanceScale, faBox, faChartLine, faCheck, faCopy, faDollarSign, faDonate, faEdit, faExchangeAlt, faExternalLinkAlt,
    faHandHolding, faHandHoldingUsd, faHandshake, faHistory, faHourglassHalf, faKey, faLink, faLock, faMoneyCheckAlt, faQrcode, faSearch, faSnowflake, faTimes, faUserClock,
    faWallet,
