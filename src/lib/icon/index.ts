...
import {
    ...
    faMoneyCheckAlt, faMoon, faPlus, faQrcode, faSearch, faSnowflake, faTimes, faUserClock, faWallet,
} from "@fortawesome/free-solid-svg-icons";

library.add(faMoon, Day, faPlus, faCheckDouble, faHandHolding, faArchive, faGoogle, faLock, faUserClock, faLink, faExternalLinkAlt, faList,
